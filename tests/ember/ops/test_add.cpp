...
TEST(TensorAddition, ComplexBroadcasting) {
    ...
    expected_grad_a(0,0,0) = 3.0; expected_grad_a(0,1,0) = 3.0;
    expected_grad_a(1,0,0) = 3.0; expected_grad_a(1,1,0) = 3.0;
    EXPECT_EQ(*a.gradient, expected_grad_a);
    
    Tensor expected_grad_b = Tensor::from_shape({1, 1, 3});
    expected_grad_b(0,0,0) = 4.0; expected_grad_b(0,0,1) = 4.0; expected_grad_b(0,0,2) = 4.0;
